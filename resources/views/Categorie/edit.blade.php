        ...
        <div class="w-full max-w-lg bg-gray-800 rounded-lg shadow p-6">
            ...
            <form action="{{ route('category.update', $category) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" class="w-full border border-gray-600 rounded px-3 py-2 bg-gray-700 text-gray-100" placeholder="Category description">{{ $category->description }}</textarea>
                </div>
